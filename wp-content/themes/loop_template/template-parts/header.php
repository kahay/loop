...
<head>
	...
	<!-- food icons -->
	<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/dist/css/organicfoodicons.css" />
	<!-- demo styles -->
	<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/dist/css/demo.css" />
	<!-- menu styles -->
    <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/dist/css/component.css" />
    <!-- lightbox -->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/dist/css/all.min.css">
    <script src="<?php echo get_template_directory_uri(); ?>/dist/js/modernizr-custom.js"></script>
